...
"""
兵哥-爱折腾三合一爬虫 整合七星、七猫、好看三个平台短剧内容均从互联网收集而来 仅供交流学习使用
"""
...
class Spider(Spider):
    ...
    def _get_qixing_detail(self, did):
        try:
            ...
            if detail.status_code == 200:
                data = detail.json()
                content = '🌺关注企鹅号“别叫偶兵哥哥”🌺获取最新接口🌺加🇶|🇶793641910防迷失！➽➽➽剧情：' + data['data'].get('introduction', '暂无剧情')
    ...
    def _get_qimao_detail(self, did):
        ...
        try:
            ...
            if detail.status_code == 200:
                ...
                content = '🌺关注企鹅号“别叫偶兵哥哥”🌺获取最新接口🌺加🇶|🇶793641910防迷失！➽➽➽剧情：' + blurb
    ...
    def _get_haokan_detail(self, did):
        try:
            ...
            return {
                "vod_id": did,
                "vod_play_from": "兵哥好看短剧",
                "vod_play_url": bofang,
                "vod_content": "🌺关注企鹅号“别叫偶兵哥哥”🌺获取最新接口🌺加🇶|🇶793641910防迷失！➽➽➽",
                "vod_remarks": "兵哥好看短剧"
            }
        except:
            pass
